...
def main():
    ...
    parser.add_argument("--decay", type=float, default=0.0, help="時間衰減率, 0表示不衰減, 建議0.01~0.05")
    ...
    model = SuggestionFusion(sugg_df=sugg_df, weights=weights, decay_rate=args.decay)
